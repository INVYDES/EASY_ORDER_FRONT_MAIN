      ...
      <div class="bg-white rounded-2xl shadow-xl w-full max-w-md p-6">
        ...
        <div class="space-y-4">
          ...
          <div class="grid grid-cols-2 gap-3">
            ...
            <div>
              <label class="block text-sm font-medium text-gray-700 mb-1" title="Se calcula de forma automática en base a las recetas y al stock mínimo de los productos que lo usan">Stock mínimo</label>
              <div class="relative">
                <input v-model="form.stock_minimo" type="number" readonly disabled
                  class="w-full px-3 py-2.5 bg-gray-100 text-gray-400 border border-gray-200 rounded-xl text-sm cursor-not-allowed font-medium" />
                <span class="absolute right-3 top-3 text-[10px] font-bold text-indigo-500" title="Autocalculado por recetas de productos">Calculado</span>
              </div>
            </div>
          </div>
          <div>
