            ...
            <div>
              ...
              <div class="relative">
                <input v-model="form.stock_minimo" type="number" readonly disabled
                  class="w-full px-3 py-2.5 bg-gray-100 dark:bg-gray-700 text-gray-400 dark:text-gray-500 border border-gray-200 dark:border-gray-600 rounded-xl text-sm cursor-not-allowed font-medium" />
